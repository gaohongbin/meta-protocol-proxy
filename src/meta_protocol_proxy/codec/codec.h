...
public:
  ...
  // 从 headers_ 中读取数据
  virtual std::string getFromHeaderMap(const std::string& key) const PURE;
};
//<<<<<<< HEAD
//=======
//
...
public:
  ...
  // tcloud 泳道相关内容
  virtual void setTcloudMap(std::shared_ptr<Envoy::TcloudMap::TcloudMap<std::string, std::string, Envoy::TcloudMap::LFUCachePolicy>> tcloud_map) PURE;
