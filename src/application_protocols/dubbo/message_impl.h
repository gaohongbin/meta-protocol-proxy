...
public:
  ...
  const std::string& parameterSize() const override { return parameter_size_; }
  void setParameterSize(std::string& parameter_size) override {
...
public:
  ...
  void setDubboVersion(const std::string& version) { dubbo_version_ = version; }
  const std::string& dubboVersion() const override { return dubbo_version_; }
