...
private:
  void toMetadata(MessageMetadata& msgMetadata, MetaProtocolProxy::Metadata& metadata);

  void toMetadata(MessageMetadata& msgMetadata, Context& context,
...
private:
  ...
  void encodeResponse(const MetaProtocolProxy::Metadata& metadata,
                      const MetaProtocolProxy::Mutation& mutation, Buffer::Instance& buffer);
  // void encodeRequest(const MetaProtocolProxy::Metadata& metadata, Buffer::Instance& buffer);
