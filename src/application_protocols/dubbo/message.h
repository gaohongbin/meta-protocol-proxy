...
public:
  ...
  virtual const std::string& parameterSize() const PURE;
  virtual void setParameterSize(std::string& parameter_size) PURE;
...
public:
  ...
  virtual const std::string& dubboVersion() const PURE;
