...
public:
  ...
  void setFlag(uint8_t flag) { flag_ = flag; }
  ...
  void setTcloudChanged(bool tcloud_changed) { tcloud_changed_ = tcloud_changed; }
  bool isTcloudChanged() const { return tcloud_changed_; }
...
private:
  ...
  uint8_t flag_ = 0;  //  dubbo 的第二个字节
  bool tcloud_changed_ {false};
