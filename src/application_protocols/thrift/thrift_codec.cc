...
void ThriftCodec::setTcloudMap(std::shared_ptr<Envoy::TcloudMap::TcloudMap<std::string, std::string, Envoy::TcloudMap::LFUCachePolicy>> tcloud_map) {
  tcloud_map_ = tcloud_map;
}

std::shared_ptr<Envoy::TcloudMap::TcloudMap<std::string, std::string, Envoy::TcloudMap::LFUCachePolicy>> ThriftCodec::getTcloudMap() {
  return tcloud_map_;
}
